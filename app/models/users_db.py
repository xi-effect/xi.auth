...
from app.common.crypto import TokenGenerator

t = TokenGenerator(randomness=40, length=50)
...
class User(Base):
    ...
    reset_token: Mapped[str | None] = mapped_column(CHAR(t.token_length))
    ...
    def generated_reset_token(self) -> str:  # noqa: FNE002  # reset is a noun here
        if self.reset_token is None:
            self.reset_token = t.generate_token()
